...
public class HotelBookingStepDefinitions extends TestBaseC {
	LoginPage loginPage;
	...
	public void i_am_on_Booking_form() throws Throwable {
		...
		loginPage.login(prop.getProperty("username"), prop.getProperty("password"));
		Assert.assertEquals(bookingForm.getBookingFormUrl(),
				"file:///C:/Users/1434894/AppData/Local/Temp/Temp1_original_1588252119_Testing_Casestudy_HotelBooking.zip/Casestudy_HotelBooking/hotelbooking.html");
	}
	...
	public void i_am_redirected_to_success_page() throws Throwable {
		...
		Assert.assertEquals(successPageObj.getSuccessPageUrl(),
				"file:///C:/Users/1434894/AppData/Local/Temp/Temp1_original_1588252119_Testing_Casestudy_HotelBooking.zip/Casestudy_HotelBooking/success.html");
